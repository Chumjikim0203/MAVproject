...
public class StoreController {
    ...
    */
			...
			File saveFile= new File(save, saveName);
			 ...
			 if(file !=null && !file.isEmpty()) {
			        try {
			            ...
			            switch(i) {
			                case 0: store.setStoreImageName1(saveName); break;
			                case 1: store.setStoreImageName2(saveName); break;
			                case 2: store.setStoreImageName3(saveName); break;
			                case 3: store.setStoreImageName4(saveName); break;
			                case 4: store.setStoreImageName5(saveName); break;
			            }
			        } catch (Exception e) {
    ...
    @GetMapping("/update")
    public String UpdateStore(@ModelAttribute("store") Store store,Model model,@RequestParam ("storeId")String storeId) {
    ...
    @PostMapping("/update")
    public String submitStore(@ModelAttribute("store") Store store,HttpServletRequest request,@RequestParam ("storeId")String storeId){
