				...
				<c:when test="${room.matched == 0}">
					<div class="card-1 mb-3">
						<div class="room-info">
							...
							<div class="room-title room-dt">
								<span class="romm-ddt">no.${room.roomNum}
									&nbsp${room.roomName}</span>
							</div>
							<span class="room-application .ehgus"> <a
								href="<c:url value='/match/roomsDetail'/>?roomNum=${room.roomNum}"
								class="room-application-link room-application-btn">조회</a> <a
								href="<c:url value='/room/roomsUpdate'/>?roomNum=${room.roomNum}"
								class="room-application-link room-application-btn">수정</a> <a
								href="<c:url value='/room/deleteMyRoom'/>?roomNum=${room.roomNum}"
								class="room-application-link room-application-btn">삭제</a>
							</span>
						</div>
					</div>
