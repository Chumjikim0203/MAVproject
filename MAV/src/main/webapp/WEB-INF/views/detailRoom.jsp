			...
			<div class="detail-row d-flex">
				...
				<div class="detail-right" style="position: relative;">
					...
					<b><p>
						...
						<form:form modelAttribute="matchForm"
							action="${pageContext.request.contextPath}/match/roomsDetail"
							method="post">
							<div id="matching_bt">
								<span>방제 :</span><br>
								...
								<br> <label for="clubSelect">동호회 :</label><br> <select
									name="selectedClub" id="clubSelect"
								...
								<button type="submit"
									class="room-application-btn4 mt-2 float-right"
									style="position: absolute; right: 20px;">매칭 만들기</button>
								<br> <br>
...
<div class="main-container">
    <div class="container">
       <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
           <div class="carousel-inner">
               <div class="carousel-item active">
                    <img src=<c:url value="/resources/images/${store.storeImageName1}"/> class="d-block w-100"></div>
             <div class="carousel-item active">
                <img src=<c:url value="/resources/images/${store.storeImageName2}"/> class="d-block w-100"></div>
             <div class="carousel-item active">
                <img src=<c:url value="/resources/images/${store.storeImageName3}"/> class="d-block w-100"></div>
           </div>
