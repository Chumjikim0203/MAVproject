					                ...
					                <c:if test="${room.roomNum == MatchRoom.roomNum}">
					                    <div class="card-1 mb-4">
					                        <div class="room-info">
					                            ...
					                            <span class="room-application .ehgus">
					                                <span class="room-application-count">0/1</span>
					                                <a href="<c:url value='/match/roomsDetail'/>?roomNum=${room.roomNum}" class="room-application-link room-application-btn2">조회</a>
					                                <!-- 수정코드 필요여부에 따라  -->
					                                <%-- <a href="<c:url value='/store/roomsUpdate'/>?roomNum=${room.roomNum}" class="room-application-link room-application-btn2">수정</a> --%>
					                                <a href="#" class="room-application-link room-application-btn2" onclick="confirmDelete(${room.roomNum});">삭제</a>
					                            </span>
					                        </div>
					                    </div>
					                </c:if>
