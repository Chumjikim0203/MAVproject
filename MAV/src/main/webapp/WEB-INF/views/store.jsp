				...
				<div class="card" style="width: 100%;">
					...
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item"><a
							href="store/delete?storeId=${store.storeId}">업주탈퇴</a></li>
					</ul>
					<div class="card-body">
